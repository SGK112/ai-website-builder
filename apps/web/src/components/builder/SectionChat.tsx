              ...
              {selectedElement && (
                <div className="px-4 pt-3">
                  <div className="flex items-center gap-2 rounded-lg bg-violet-500/15 border border-violet-500/30 px-3 py-2">
                    <Sparkles className="w-3.5 h-3.5 text-violet-700 dark:text-violet-300 shrink-0" />
                    <div className="min-w-0 flex-1">
                      <div className="text-[10px] uppercase tracking-wider text-violet-700/80 dark:text-violet-300/80 font-semibold">
