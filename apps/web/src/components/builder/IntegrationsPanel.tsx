...
const AVAILABLE_INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    keyPlaceholder: 'Replicate API token',
  ...
  // Payments
  {
    ...
    keyPlaceholder: 'Stripe secret key',
  ...
  },
  {
    ...
    keyPlaceholder: 'Stripe webhook signing secret',
  ...
  // Storage
  {
    ...
    category: 'storage',
    keyName: 'MONGODB_URI',
    keyPlaceholder: 'MongoDB connection string',
  ...
  },
  {
    ...
    keyPlaceholder: 'Supabase service-role key',
    docsUrl: 'https://supabase.com/dashboard/project/_/settings/api',
  },
  {
    id: 'cloudinary',
  ...
  // Email
  {
    ...
    keyPlaceholder: 'SendGrid API key',
  ...
  // Analytics
  {
    ...
    keyPlaceholder: 'GA4 measurement id',
  ...
  },
  {
    ...
    keyPlaceholder: 'PostHog project key',
  ...
  },
  {
    ...
    keyPlaceholder: 'GitHub App client id',
  ...
  },
  {
    ...
    keyPlaceholder: 'Google OAuth client id',
  ...
  },
  {
    ...
    keyPlaceholder: 'GitHub personal access token',
...
export function IntegrationsPanel({ projectId, savedKeys = {}, onSaveKeys }: IntegrationsPanelProps) {
  ...
  return (
    <div className="fixed bottom-4 left-3 right-3 sm:left-20 sm:right-auto sm:w-[420px] bg-white rounded-xl shadow-2xl border overflow-hidden z-50">
      {/* Header */}
