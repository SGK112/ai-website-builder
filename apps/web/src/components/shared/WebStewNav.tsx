...
export function WebStewNav() {
  ...
  return (
    <header
      className={cn(
        // pt-safe reserves the iPhone notch when running as a PWA. Every
        // page in the app uses this nav, so doing it once here covers all
        // pages without per-page surgery.
        'sticky top-0 z-50 border-b backdrop-blur-xl transition-colors pt-safe',
