    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href={`/login?callbackUrl=${encodeURIComponent('/admin/marketplace')}`} className="text-violet-400 hover:text-violet-300">Sign in →</Link>
        </div>
      </div>
    )
  }
                    ...
                    topSellers.map((s) => (
                      <div key={s._id} className="px-5 py-3 flex items-center justify-between gap-3">
                        ...
                        <div className="text-right">
                          <p className="font-bold text-violet-300">{(s.marketplace_earnings_credits || 0).toLocaleString()}</p>
